...
public class SiegeComptesController {
        ...
        if(combo_flag && cin_flag){
            ...
            if(typeCompte.contains("épargne")) {
                ...
                if (Client.getClientCEAccountsCount(CIN) == 0) {
                    ...
                    alert.setHeaderText(null);
                    alert.setContentText("Le taux doit être compris entre 0 et 100%. Seul les caractères numériques seront acceptés");
                    alert.initOwner(Main.stage.getOwner());
                    alert.show();
                }
            }
    ...
    @FXML
    public void gotoAgences(MouseEvent e) throws Exception{
